<template>
		...
		<div class="app-contain">
			...
			<el-table v-loading="listLoading" border :stripe='true' ref="table" :data="list">
				...
				<el-table-column label="考试名称" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.papername}}
					</template>
				</el-table-column>
				...
				<el-table-column label="正确答案" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.answer}}
					</template>
				</el-table-column>
				...
				<el-table-column label="考生答案" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.myanswer}}
					</template>
				</el-table-column>
				<el-table-column label="考试时间" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.addtime}}
					</template>
				</el-table-column>
