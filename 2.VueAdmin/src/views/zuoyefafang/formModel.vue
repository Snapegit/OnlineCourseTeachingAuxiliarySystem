				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="发放时间" prop="fafangshijian">
							<el-date-picker
								class="list_date"
								v-model="form.fafangshijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.fafangshijian?true:false"
								placeholder="请选择发放时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="评分" prop="pingfen">
							<el-input class="list_inp" v-model.number="form.pingfen" placeholder="评分"
								 type="number" 								:readonly="!isAdd||disabledForm.pingfen?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="作业评价" prop="zuoyepingjia">
							<el-input v-model="form.zuoyepingjia" placeholder="作业评价" type="textarea"
							:readonly="!isAdd||disabledForm.zuoyepingjia?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.fafangshijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='zuoyepingjia'){
					form.value.zuoyepingjia = row[x];
					disabledForm.value.zuoyepingjia = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
				...
				if(x=='fafangshijian'){
					form.value.fafangshijian = row[x];
					disabledForm.value.fafangshijian = true;
					continue;
				}
				if(x=='pingfen'){
