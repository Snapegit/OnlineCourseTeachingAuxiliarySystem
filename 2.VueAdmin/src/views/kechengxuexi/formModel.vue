		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="学习时间" prop="xuexishijian">
							<el-date-picker
								class="list_date"
								v-model="form.xuexishijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.xuexishijian?true:false"
								placeholder="请选择学习时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="学习时长" prop="xuexishizhang">
							<el-input class="list_inp" v-model.number="form.xuexishizhang" placeholder="学习时长"
								 type="number" 								:readonly="!isAdd||disabledForm.xuexishizhang?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="课程大纲" prop="kechengdagang">
							<el-input v-model="form.kechengdagang" placeholder="课程大纲" type="textarea"
							:readonly="!isAdd||disabledForm.kechengdagang?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="课程重点" prop="kechengzhongdian">
							<el-input v-model="form.kechengzhongdian" placeholder="课程重点" type="textarea"
							:readonly="!isAdd||disabledForm.kechengzhongdian?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="课程难点" prop="kechengnandian">
							<el-input v-model="form.kechengnandian" placeholder="课程难点" type="textarea"
							:readonly="!isAdd||disabledForm.kechengnandian?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="进度安排" prop="jinduanpai">
							<el-input v-model="form.jinduanpai" placeholder="进度安排" type="textarea"
							:readonly="!isAdd||disabledForm.jinduanpai?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const disabledForm = ref({
		...
		kechengdagang : false,
		kechengzhongdian : false,
		kechengnandian : false,
		jinduanpai : false,
		xuexishijian : false,
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.xuexishijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='kechengdagang'){
					form.value.kechengdagang = row[x];
					disabledForm.value.kechengdagang = true;
					continue;
				}
				if(x=='kechengzhongdian'){
					form.value.kechengzhongdian = row[x];
					disabledForm.value.kechengzhongdian = true;
					continue;
				}
				if(x=='kechengnandian'){
					form.value.kechengnandian = row[x];
					disabledForm.value.kechengnandian = true;
					continue;
				}
				if(x=='jinduanpai'){
					form.value.jinduanpai = row[x];
					disabledForm.value.jinduanpai = true;
					continue;
				}
				if(x=='xuexishijian'){
					form.value.xuexishijian = row[x];
					disabledForm.value.xuexishijian = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
				...
				if(x=='xuexishizhang'){
					form.value.xuexishizhang = row[x];
					disabledForm.value.xuexishizhang = true;
					continue;
				}
				if(x=='jiaoshigonghao'){
