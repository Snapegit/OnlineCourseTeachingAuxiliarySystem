...
<template>
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button type="warning" @click="echartClick1" v-if="btnAuth('chengjixinxi','成绩统计')">成绩统计</el-button>
				</div>
			</div>
			<br>
			<el-table
		...
		<el-dialog v-model="echartVisible" :title="'成绩统计'" width="70%">
			<div  id="chengjiEchart1" style="width:100%;height:600px;"></div>
...
<script setup>
	...
	const echartClick1 = ()=>{
		...
		nextTick(()=>{
			var chengjiEchart1 = echarts.init(document.getElementById("chengjiEchart1"),'macarons');
			context?.$http({
