			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="学期" prop="xueqi">
						<el-input class="list_inp" v-model="form.xueqi" placeholder="学期"
							 type="text" 							:readonly="!isAdd||disabledForm.xueqi?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="12">
					<el-form-item label="成绩" prop="chengji">
						<el-input class="list_inp" v-model.number="form.chengji" placeholder="成绩"
							 type="number" 							:readonly="!isAdd||disabledForm.chengji?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="12">
					<el-form-item label="成绩类型" prop="chengjileixing">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.chengjileixing?true:false"
							v-model="form.chengjileixing" 
							placeholder="请选择成绩类型"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in chengjileixingLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xueqi'){
					form.value.xueqi = row[x];
					disabledForm.value.xueqi = true;
					continue;
				}
				if(x=='chengji'){
				...
				if(x=='chengjileixing'){
					form.value.chengjileixing = row[x];
					disabledForm.value.chengjileixing = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
		...
		chengjileixingLists.value = "考试成绩,作业成绩".split(',')
		context?.$http({
