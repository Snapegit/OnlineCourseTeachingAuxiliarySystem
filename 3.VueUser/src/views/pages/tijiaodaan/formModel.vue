			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						{{detail.shijuanmingcheng}}
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">题目简述</div>
					<div  class="info_text" >{{detail.timujianshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">答案信息</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.daanxinxi" @click="downClick(detail.daanxinxi)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'批改')" @click="pigaixinxionAcross('批改','pigaixinxi','','[1]','已批改')" type="warning">批改</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('tijiaodaan','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('tijiaodaan','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('tijiaodaan','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.shijuanmingcheng
	...
	const pigaixinxionAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
