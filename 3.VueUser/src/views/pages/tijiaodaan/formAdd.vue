	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"20px","background":"#fff","width":"64%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="答案信息" prop="daanxinxi">
						<uploads
							:disabled="!isAdd||disabledForm.daanxinxi?true:false"
							type="file"
							action="file/upload" 
							tip="请上传答案信息" 
							:limit="1" 
							style="width: 100%;text-align: left;"
							:fileUrls="form.daanxinxi?form.daanxinxi:''" 
							@change="daanxinxiUploadSuccess">
						</uploads>
					</el-form-item>
				</el-col>
				<el-col :span="12">
...
<script setup>
	...
	//答案信息上传回调
	const daanxinxiUploadSuccess=(e)=>{
		form.value.daanxinxi = e
	}
	//methods
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='daanxinxi'){
					form.value.daanxinxi = row[x];
					disabledForm.value.daanxinxi = true;
					continue;
				}
				if(x=='tijiaoshijian'){
	...
	//提交
	const save=()=>{
		if(form.value.daanxinxi!=null) {
			form.value.daanxinxi = form.value.daanxinxi.replace(new RegExp(context?.$config.url,"g"),"");
		}
