	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"20px","background":"#fff","width":"64%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="题目详情" prop="timuxiangqing">
						<uploads
							:disabled="!isAdd||disabledForm.timuxiangqing?true:false"
							type="file"
							action="file/upload" 
							tip="请上传题目详情" 
							:limit="1" 
							style="width: 100%;text-align: left;"
							:fileUrls="form.timuxiangqing?form.timuxiangqing:''" 
							@change="timuxiangqingUploadSuccess">
						</uploads>
					</el-form-item>
				</el-col>
				<el-col :span="12">
...
<script setup>
	...
	//题目详情上传回调
	const timuxiangqingUploadSuccess=(e)=>{
		form.value.timuxiangqing = e
	}
	//methods
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='timuxiangqing'){
					form.value.timuxiangqing = row[x];
					disabledForm.value.timuxiangqing = true;
					continue;
				}
				if(x=='fabushijian'){
	...
	const save=()=>{
		...
		if(form.value.timuxiangqing!=null) {
			form.value.timuxiangqing = form.value.timuxiangqing.replace(new RegExp(context?.$config.url,"g"),"");
		}
