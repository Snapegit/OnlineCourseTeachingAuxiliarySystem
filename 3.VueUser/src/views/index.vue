<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">线上一流课程教学辅助系统</div>
			...
			<div class="rotation_view">
				<mySwiper :type="3" :data="rotationList" :autoHeight="false" :autoplay="true"
					...
					<template #default="scope">
						<img :style='{"border":"0px solid #fff","width":"100%","borderRadius":"20px","height":"480px"}' :src="scope.row.value?$config.url + scope.row.value:''">
					</template>
				</mySwiper>
			</div>
			<router-view />
...
<style lang="scss" scoped>
	...
	.index_top {
		...
		z-index: 1002;
		color: #333;
		background: url(http://clfile.zggen.cn/20231017/1e48cf850fc543c48d90a1962bbf270f.jpg) repeat-x center top / auto 100%,#fff;
		display: block;
		width: 100%;
		...
		.index_top_title {
			...
			color: #333;
			top: 0;
			background: url(http://clfile.zggen.cn/20231017/caa66136a9424ce5b60ed34923d244ea.png) no-repeat left center / auto 100%;
			font-weight: 500;
			font-size: 22px;
			position: absolute;
			text-align: center;
